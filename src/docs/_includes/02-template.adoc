...
** Ripple effect (can be disabled)
** Touch enabled menu to slide in/out (can be disabled)
** Scroll to top
* Automatically activates (highlight) menu based on current page
* Custom <<Error Pages, error pages>>
* Configurable, see <<Configuration>>
* http://adminfaces-rpestano.rhcloud.com/showcase/pages/layout/breadcrumb.xhtml[Breadcrumb^] based navigation; (can be disabled)
