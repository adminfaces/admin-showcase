...
This project uses http://stackoverflow.com/questions/20909634/what-is-the-purpose-of-classifier-tag-in-maven[maven classifiers^] to offer multiple `faces` (pum intended) of Admin Theme. Below is the explanation of each classifier and how to use it.
...
include::{projectRoot}/pom.xml[tags=version]
</dependency>
----
